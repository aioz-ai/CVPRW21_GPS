...
class DukeMTMCreID(BaseImageDataset):
    ...
    def __init__(self, root='/home/haoluo/data', verbose=True, **kwargs):
        ...
        self.att_train = pickle.load(open(osp.join(self.dataset_dir, 'attribute/duke_train_att.pkl'), 'rb'))
        self.att_test = pickle.load(open(osp.join(self.dataset_dir, 'attribute/duke_test_att.pkl'), 'rb'))

        self.att_name = pickle.load(open(osp.join(self.dataset_dir, 'attribute/duke_att_label.pkl'), 'rb'))
